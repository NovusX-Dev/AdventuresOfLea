...
public class MazeGenerator : MonoBehaviour
{
    ...
    public void CreateLayout()
    {
        ...
        Vector3 startPos = Vector3.zero;// new Vector2(-(cellSize * (mazeColumns / 2)) + (cellSize / 2), -(cellSize * (mazeRows / 2)) + (cellSize / 2));
    ...
    public void GenerateCell(Vector3 pos, Vector3 keyPos)
    {
        ...
        if (disableCellSprite) newCell.cellObject.GetComponent<MeshRenderer>().enabled = false;
    ...
    public void MakeExit()
    {
        ...
        else if (newCell.gridPos.z == mazeRows) RemoveWall(newCell.cScript, 3);
    ...
    //public Vector2Int GetKeyPos()
    //{
    //    Vector2Int keypos = Vector2Int.zero;
    //    keypos.x = (int)_keyPos.x;
    //    keypos.y = (int)_keyPos.y;
